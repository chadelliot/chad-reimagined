...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Time-based check (bot fills forms instantly)
        ...
        <div className="grid md:grid-cols-[1fr_380px] gap-12 md:gap-20">
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="font-sans text-[14px] text-muted-foreground max-w-[360px]">
                  Your email client should have opened with the message ready to send. If it didn't, feel free to email me directly at{" "}
                  <a href="mailto:cparker@audaption.com" className="text-primary hover:underline">cparker@audaption.com</a>.
                </p>
                <button
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      maxLength={100}
                      className="w-full px-4 py-3 rounded-md border border-border bg-card text-foreground font-sans text-[14px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    maxLength={2000}
                    rows={6}
                    className="w-full px-4 py-3 rounded-md border border-border bg-card text-foreground font-sans text-[14px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors resize-y"
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-md bg-primary text-primary-foreground font-sans text-[12px] tracking-[0.1em] uppercase font-medium hover:opacity-90 transition-opacity cursor-pointer border-none disabled:opacity-50"
                >
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 rounded-lg border border-border bg-card">
              <h3 className="font-display text-[15px] font-bold text-foreground mb-3">Direct Email</h3>
              <a
                href="mailto:cparker@audaption.com"
                className="font-sans text-[14px] text-primary hover:underline"
              >
            ...
            <div
              ...
              style={{ background: "linear-gradient(135deg, rgba(47,163,127,0.06), rgba(47,163,127,0.02))" }}
            >
              <div className="flex items-center gap-2 mb-2">
                <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                <span className="font-sans text-[11px] tracking-[0.12em] uppercase text-primary font-medium">
                  Available
                </span>
              </div>
              <p className="font-sans text-[13px] text-muted-foreground leading-[1.7]">
